...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="essential"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/8c/0bhqkjrx3h1gm8_zry0dwxrc0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/yash/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/yash/.mailcheckrc"
# }
